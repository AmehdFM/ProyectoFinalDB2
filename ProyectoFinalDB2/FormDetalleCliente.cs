...
namespace ProyectoFinalDB2
{
    public class FormDetalleCliente : Form
    {
        ...
        private void MostrarGrid(string tipo)
        {
            ...
            string sql = "";
            if (tipo == "Plan") {
                cmd.CommandText = "sp_GetPlanPagoClienteHome";
                cmd.CommandType = CommandType.StoredProcedure;
            } else if (tipo == "Historial") {
                cmd.CommandText = "sp_GetHistorialPagosClienteHome";
                cmd.CommandType = CommandType.StoredProcedure;
            } else if (tipo == "Facturas") {
                cmd.CommandText = "sp_GetFacturasCliente";
                cmd.CommandType = CommandType.StoredProcedure;
            }
            ...
            try
            {
                ...
                {
                    // sp_ selector is already set above in the if(tipo) block
